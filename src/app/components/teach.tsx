...
const FrameworkCard = () => {
  ...
  const cardClasses =
    "flex aspect-square items-center justify-center backdrop-blur-sm rounded-md border-2 border-neutral-400/20 bg-gradient-to-b from-slate-700/10 to-slate-800/20 p-4 " +
    "[@media(min-width:320px)]:h-20 [@media(min-width:500px)]:h-20 " +
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className={cardClasses} style={{ transform: tailwindIconTransform }}>
            <TailwindIcon className="size-6 text-neutral-100 [@media(min-width:500px)]:size-9" />
          </div>
...
const TailwindIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M180 0L0 0L0 180L180 180L180 0Z" fill="white" />
  </svg>
);
