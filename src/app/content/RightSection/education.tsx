...
function Education({ addSectionId }: EducationProps) {
            ...
            <div className="grid p-4 gap-2">
              <div className="flex md:flex-row flex-col gap-[32px]">
                <div className="text-white font-semibold w-[100px]">
                  <span className="text-slate-500 uppercase font-semibold text-xs">
                    {t("education.period")}
                  </span>
                </div>
                <div className="flex flex-col gap-1 w-full text-lg">
                  ...
                  <span className="text-white font-semibold">
                    <span className="md:block hidden">{t("education.universityLabel")}{` `}</span>
                    <span className="text-slate-500  font-normal text-ellipsis line-clamp-2">
                      {t("education.university")}
                    </span>
                  </span>
                  <span className="text-white font-semibold">
                    {t("education.majorLabel")} {` `}
                    <span className="text-slate-500  font-normal">{t("education.major")}</span>
                  </span>
